        ...
        <div className="col-span-6 sm:col-span-3">
          <p className="u-mono text-[10px] uppercase tracking-[0.3em] text-theme-ink/40">
            ...
            {isAI ? (
              <>
                {' '}
                <span aria-hidden className="text-theme-ink/25">॥</span>
                {' '}
                <span className="ai-devanagari normal-case tracking-normal">{hindiCopy.index}</span>
              </>
            ) : null}
          </p>
          ...
          <p className="u-mono text-[10px] uppercase tracking-[0.3em] text-theme-ink/40">
            ...
            {isAI ? (
              <>
                ...
                <span aria-hidden className="text-theme-ink/25">॥</span>
                {' '}
                <span className="ai-devanagari normal-case tracking-normal">{hindiCopy.elsewhere}</span>
              </>
            ) : null}
          </p>
          <ul className="mt-2 space-y-1 text-sm">
